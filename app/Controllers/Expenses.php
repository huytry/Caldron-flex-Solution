...
class Expenses extends Security_Controller {
    ...
    function yearly_chart_data() {
        ...
        if ($year) {
            $expenses = $this->Expenses_model->get_yearly_expenses_chart($year, 0, $this->show_own_expenses_only_user_id());
            $values = array();
    ...
    function income_vs_expenses_chart_data() {
        ...
        if ($year) {
            $expenses_data = $this->Expenses_model->get_yearly_expenses_chart($year, $project_id, $this->show_own_expenses_only_user_id());
            ...
            $payments_data = $this->Invoice_payments_model->get_yearly_payments_chart($options);
    ...
    function income_vs_expenses_summary_list_data() {
        ...
        if ($year) {
            $expenses_data = $this->Expenses_model->get_yearly_expenses_chart($year[0], $project_id, $this->show_own_expenses_only_user_id());
