                    ...
                    ?>
                        <div class="w250">
                            <div class="text-end">
                                ...
                                <h3 class="mt40 mb0 text-primary <?php echo $payments == 0 ? 'text-off text-default' : ''; ?>"><?php echo to_currency($payments, $currency_symbol); ?></h3>
                                <div><?php echo app_lang("payments"); ?></div>

                                <h3 class="mt40 mb0 text-danger <?php echo $due == 0 ? 'text-off text-default' : ''; ?>"><?php echo to_currency($due, $currency_symbol); ?></h3>
