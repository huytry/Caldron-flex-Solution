    ...
    <div class="card full-width-button">
        <?php if ($is_mobile) { ?>
            <div class="card-header">
                <span class="fw-bold"><i data-feather="calendar" class="icon-16"></i> &nbsp;<?php echo app_lang("events"); ?></span>
                <div class="float-end">
                    <?php echo modal_anchor(get_uri("events/modal_form"), "<i data-feather='plus' class='icon-16'></i> " . app_lang('add_event'), array("title" => app_lang('add_event'), "data-post-client_id" => $client)); ?>
                </div>
            </div>
